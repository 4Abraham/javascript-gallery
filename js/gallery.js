...
//             let getImgUrlPos = getFullImageUrl.split("/img/thumb/");
...
//             newImg.setAttribute("id", "img/" + "current-img");
           

//             newImg.onload = function () {
//                 let imgWidth = this.width;
//                 let calcImgToEdge = ((windowWidth - imgWidth)/2)-80;/*calculate the btns dist from the img to be 80px*/
